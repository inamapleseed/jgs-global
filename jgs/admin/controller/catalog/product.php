		...
		foreach ($results as $result) {
			...
			foreach ($product_specials  as $product_special) {
				...
				if (($product_special['date_start'] == '0000-00-00' || strtotime($product_special['date_start']) <= strtotime(date('Y-m-d'))) && ($product_special['date_end'] == '0000-00-00' || strtotime($product_special['date_end']) >= strtotime(date('Y-m-d')))) {
					...
					$specialwtax = $product_special['pricewtax'];
					$checkout_price = $product_special['checkout_price'];
					$checkout_price = $product_special['checkout_tax'];
					$tax = $product_special['tax'];
					$tax_label = $product_special['tax_label'];
	...
	protected function getForm() {
		...
		foreach ($product_specials as $product_special) {
			$data['product_specials'][] = array(
				...
				'pricewtax'         => $product_special['pricewtax'],
				'checkout_price'    => $product_special['checkout_price'],
				'checkout_tax'    => $product_special['checkout_tax'],
				'tax_label'         => $product_special['tax_label'],
				'tax'        		=> $product_special['tax'],
