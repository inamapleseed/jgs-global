...
class ControllerCatalogManufacturer extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['manufacturer_related'])) {
			$products2 = $this->request->post['manufacturer_related'];
		} elseif (isset($this->request->get['manufacturer_id'])) {
			$products2 = $this->model_catalog_manufacturer->getProductRelated2($this->request->get['manufacturer_id']);
		} else {
			$products2 = array();
		}

		$data['manufacturer_relateds'] = array();

		foreach ($products2 as $manufacturer_id) {
			$related_info = $this->model_catalog_product->getProduct($manufacturer_id);
