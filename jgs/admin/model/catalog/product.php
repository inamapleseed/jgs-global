	...
	public function addProduct($data) {
		...
		if (isset($data['product_special'])) {
			foreach ($data['product_special'] as $product_special) {
				$this->db->query("INSERT INTO " . DB_PREFIX . "product_special SET product_id = '" . (int)$product_id . "', customer_group_id = '" . (int)$product_special['customer_group_id'] . "', priority = '" . (int)$product_special['priority'] . "', pricewtax = '" . (float)$product_special['pricewtax'] . "', checkout_price = '" . (float)$product_special['checkout_price'] . "', tax = '" . (float)$product_special['tax'] . "', checkout_tax = '" . (float)$product_special['checkout_tax'] . "', tax_label = '" . $this->db->escape($product_special['tax_label']) . "', price = '" . (float)$product_special['price'] . "', date_start = '" . $this->db->escape($product_special['date_start']) . "', date_end = '" . $this->db->escape($product_special['date_end']) . "'");
			}
		}
		// debug($data['product_special']);die();
