...
class ModelReportProduct extends Model {
	...
	public function getPurchased($data = array()) {
		$sql = "SELECT op.name, op.sku, op.model, SUM(op.quantity) AS quantity, SUM((op.price + op.tax) * op.quantity) AS total FROM " . DB_PREFIX . "order_product op LEFT JOIN `" . DB_PREFIX . "order` o ON (op.order_id = o.order_id)";
