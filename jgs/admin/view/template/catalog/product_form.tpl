...
<div id="content">
			...
			<div class="panel-body">
				<form action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
					<ul class="nav nav-tabs">
						...
						<li class="hidden"><a href="#tab-discount" data-toggle="tab"><?= $tab_discount; ?></a></li>
							...
							<div class="form-group" hidden>
								...
								<div class="col-sm-10">
									<select name="tax_class_id" id="input-tax-class" class="form-control">
										<option value="0">(ii) Exc GST</option>
								...
								<table id="special" class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											...
											<td class="text-right hidden"><?php echo 'Tax Label'; ?></td>
											<td class="text-right">Total Price</td>
											<td class="text-right hidden">Checkout Price</td>
											<td class="text-right hidden">Total Tax On Checkout</td>
											<td class="text-left"><?= $entry_date_start; ?></td>
											<td class="text-left"><?= $entry_date_end; ?></td>
											<td></td>
										</tr>
									...
									<tbody>
										...
										<?php foreach ($product_specials as $product_special) { ?>
											<tr id="special-row<?= $special_row; ?>">
												...
												<td class="text-right"><input type="text" name="product_special[<?= $special_row; ?>][priority]" value="<?= $product_special['priority']; ?>" placeholder="<?= $entry_priority; ?>" class="form-control" />
												</td>
												<!-- pdp -->
												<td class="text-right">
													<div class="input-group">
														<input type="text" value="" placeholder="<?= $entry_percentage; ?>" class="form-control percent-input percent-input<?= $special_row; ?>" data-target="#tax_input<?= $special_row; ?>" data-calc="product_special[<?= $special_row; ?>][price]" data-id="<?php echo $special_row; ?>"/>
														<span class="input-group-btn">
												...
												<td class="text-right"><input type="text" name="product_special[<?= $special_row; ?>][price]" value="<?= $product_special['price']; ?>" placeholder="<?= $entry_price; ?>" class="form-control price-special price-special<?= $special_row; ?>" data-calc="percent-input<?= $special_row; ?>" data-id="<?=$special_row;?>" data-target="#tax_input<?= $special_row;?>"/></td>

								<td class="text-right">
									<select class="form-control input-group myselect" data-id="<?=$special_row;?>" name="product_special[<?= $special_row; ?>][tax]" id="mySelect<?= $special_row; ?>">

										<?php if ($product_special['price'] == $product_special['pricewtax']): ?>
											<option value="0" selected="selected" id="no_tax_input<?=$special_row; ?>">Exc GST</option>
											<option value="<?= $product_special['tax']; ?>" id="tax_input<?= $special_row;?>" class="tax-input tax-input<?= $special_row; ?>" data-calc="product_special[<?= $special_row; ?>][price]">Inc GST (+7%)</option>
										<?php else: ?>
											<option value="0" id="no_tax_input<?=$special_row; ?>">Exc GST</option>
											<option selected="selected" value="<?= $product_special['tax']; ?>" id="tax_input<?= $special_row;?>" class="tax-input tax-input<?= $special_row; ?>" data-calc="product_special[<?= $special_row; ?>][price]">Inc GST (+7%)</option>
										<?php endif ?>

									</select>
								</td>
								<?php if ($product_special['price'] == $product_special['pricewtax']): ?>
									<td hidden class="text-right"><input type="text" name="product_special[<?= $special_row; ?>][tax_label]" value="Exc GST" placeholder="Tax exc or inc?" readonly class="form-control tax_label tax_label<?=$special_row;?>"/></td>
								<?php else: ?>
									<td hidden class="text-right"><input type="text" name="product_special[<?= $special_row; ?>][tax_label]" value="Inc GST" placeholder="Tax exc or inc?" readonly class="form-control tax_label tax_label<?=$special_row;?>"/></td>
								<?php endif ?>

												<td class="text-right"><input type="text" name="product_special[<?= $special_row; ?>][pricewtax]" value="<?= $product_special['pricewtax']; ?>" placeholder="Price with GST" readonly class="form-control pricewtax pricewtax<?=$special_row;?>"/></td>

												<td class="text-right hidden"><input type="text" name="product_special[<?= $special_row; ?>][checkout_price]" value="<?= $product_special['checkout_price']; ?>" placeholder="Checkout Price" readonly class="form-control checkout_price checkout_price<?=$special_row;?>"/></td>

												<td class="text-right hidden"><input type="text" name="product_special[<?= $special_row; ?>][checkout_tax]" value="<?= $product_special['checkout_tax']; ?>" placeholder="Tax on Checkout" readonly class="form-control checkout_tax checkout_tax<?=$special_row;?>"/></td>
									<!-- pdp -->
												<td class="text-left" style="width: 20%;"><div class="input-group date">
	...
	<script type="text/javascript">
		...
		function addSpecial() {
			...
			html += '		<input type="text" value="" placeholder="<?= $entry_percentage; ?>" class="form-control percent-input percent-input' + special_row + '" data-target="#tax_input' + special_row + '" data-calc="product_special[' + special_row + '][price]" data-id="' + special_row + '"/>';
			html += '		<span class="input-group-btn">';
			html += '			<button class="btn btn-default" type="button">%</button>';
			html += '		</span>';
			html += '	</div>';
			html += '  </td>';
			html += '  <td class="text-right"><input type="text" name="product_special[' + special_row + '][price]" value="" placeholder="<?= $entry_price; ?>" class="form-control price-special price-special'+ special_row +'" data-calc="percent-input' + special_row + '" data-id="'+ special_row +'" data-target="#tax_input' + special_row + '"/></td>';
			// pdp
			html += '  <td class="text-right">';
			html += '  	<select class="form-control input-group myselect" data-id="' + special_row + '" name="product_special[' + special_row + '][tax]" id="mySelect' + special_row + '"> ';
			html += '	<option value="" id="tax_input' + special_row + '" class="tax-input tax-input' + special_row + '" data-calc="product_special[' + special_row + '][price]">Inc GST (+7%)</option><option value="0" id="no_tax_input' + special_row + '">Exc GST</option>'
			html += '	</select>';
			html += '  </td>';
			// pdp
			html += '<td class="text-right hidden "><input type="text" name="product_special[' + special_row + '][tax_label]" value="" placeholder="Tax exc or inc?" readonly class="form-control tax_label tax_label'+ special_row +'"/></td>'
			html += '  <td class="text-right"><input type="text" name="product_special[' + special_row + '][pricewtax]" value="" placeholder="Price with GST" readonly class="form-control  pricewtax pricewtax' + special_row + '" /></td>';
			html += '  <td class="text-right hidden"><input type="text" name="product_special[' + special_row + '][checkout_price]" value="" placeholder="Checkout Price" readonly class="form-control  checkout_price checkout_price' + special_row + '" /></td>';
			html += '  <td class="text-right hidden"><input type="text" name="product_special[' + special_row + '][checkout_tax]" value="" placeholder="Tax on Checkout" readonly class="form-control  checkout_tax checkout_tax' + special_row + '" /></td>';
			// pdp ^
	...
	function getTax(new_price) {
		var tax = Number(new_price) * .07;
		return(tax).toFixed(2);
	}

	function getPriceWTax(new_price, tax) {
		var val1 = Number(new_price);
		var val2 = Number(tax);
	...
	$(document).on('keyup', '.percent-input', function(){
		...
		// pdp
		var indiv_tax = getTax(new_price);
		$($(this).data('target')).val(indiv_tax);

		var id = $(this).data('id');
		var pricewtax = getPriceWTax(new_price, indiv_tax);
		$('.pricewtax' + id).val(pricewtax);

		$(".tax_label" + id).val('Inc GST');

		$(".checkout_price" + id).val(pricewtax);
		// update tax
		$("#no_tax_input" + id).removeAttr("selected", "selected");
		$(".tax-input" + id).attr("selected", "selected");
		// get tax only
		$(".checkout_tax" + id).val(indiv_tax);
	});
	...
	// get option value on click
	$(document).on('click', '.myselect', function(){
		var thisID = $(this).data("id");
		var priceSpecial = $('.price-special' + thisID).val();

		var indiv_tax = getTax(priceSpecial);
		$("#tax_input" + thisID).val(indiv_tax);

		$("#mySelect" + thisID).on('change', function(){

			var value = $(this).val();
			if (value == 0) {
				$(".tax_label" + thisID).val('Exc GST');
			} else {
				$(".tax_label" + thisID).val('Inc GST');
			}
			// value plus price-special
			if (!priceSpecial == '') {
				var priceNtax = Math.abs(Number(value) + Number(priceSpecial));
			} else {
				var priceNtax = value;
			}
			// show price on price&gst upon choosing tax
			$(".pricewtax" + thisID).val(priceNtax);
		})
	})
</script>
</div>
