        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-featured" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10"><a href="" id="thumb-image" data-toggle="image" class="img-thumbnail"><img src="<?= $thumb; ?>" alt="" title="" data-placeholder="<?= $placeholder; ?>" /></a>
              <input type="hidden" name="custom_image" value="<?= $custom_image; ?>" id="input-image" />
            </div>
          </div>

          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-bg_image">Background Image</label>
            <div class="col-sm-10"><a href="" id="thumb-image2" data-toggle="image" class="img-thumbnail"><img src="<?= $thumb2; ?>" alt="" title="" data-placeholder="<?= $placeholder2; ?>" /></a>
              <input type="hidden" name="bg_image" value="<?= $custom_bg_image; ?>" id="input-bg_image" />
            </div>
          </div>
