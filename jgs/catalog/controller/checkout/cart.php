...
// pdp
				if ($this->customer->isLogged() || !$this->config->get('config_customer_price')) {
					...
					$checkout_tax = $this->currency->format($product['quantity'] * $product['checkout_tax'], $this->session->data['currency']);
					$checkout_tax2 = $product['quantity'] * $product['checkout_tax'];
	...
	public function add() {
		...
		// debug($product_info['checkout_tax']);die();
