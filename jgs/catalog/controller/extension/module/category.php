...
class ControllerExtensionModuleCategory extends Controller {
	...
	private function getPriceFilter(){
		...
		if( isset($this->request->get['price_min']) && (float)$this->request->get['price_min'] > -1 && $price_min != ''){
		...
		if( isset($this->request->get['price_max']) && (float)$this->request->get['price_max'] > -1 && $price_max != ''){
