	...
	public function index($setting) {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
	      ...
	      //$mail->setFrom($this->request->post['email']);
			...
			$mail->setSubject(html_entity_decode(sprintf($this->language->get('subject2'), $this->request->post['subject2']), ENT_QUOTES, 'UTF-8'));
		...
		$data['ctitle'] = $modulehelper->get_field($oc, $modulename, $language_id, 'ctitle');
		$data['cbg'] = $modulehelper->get_field($oc, $modulename, $language_id, 'cbg');
