	...
	public function index() {
		...
		foreach ($products as $product) {
			...
			if ($this->customer->isLogged() || !$this->config->get('config_customer_price')) {
				...
				$checkout_tax = $this->currency->format($this->tax->calculate($product['checkout_tax'], $product['tax_class_id'], $this->config->get('config_tax')), $this->session->data['currency']);
			} else {
				$price = false;
				$checkout_tax = false;
			}
			...
			if ($this->customer->isLogged() || !$this->config->get('config_customer_price')) {
				...
				$checkout_tax = $this->currency->format($this->tax->calculate($product['checkout_tax'], $product['tax_class_id'], $this->config->get('config_tax')) * $product['quantity'], $this->session->data['currency']);
				$checkout_tax2 = $product['checkout_tax'] * $product['quantity'];
				/* completecombo */
