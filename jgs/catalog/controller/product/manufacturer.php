...
class ControllerProductManufacturer extends Controller {
	public function index() {
		...
		foreach ($results as $result) {
			...
			//pameladenise
			$results2 = $this->model_catalog_manufacturer->getProductRelated2($result['manufacturer_id']);
			$products2 = array();
			if ($results2) {
				foreach ($results2 as $result2) {
					$products2[] = $result2;
					$data['products'][] = $this->load->controller('component/product_info', $result2['product_id']);
				}
				// debug($products2);
			}
			...
			// if ($data['categories']) {
			// 	// debug($data['categories'][$key]['manufacturer']);
			// }
		}
