<?php
    class ControllerComponentProductInfo extends Controller{
        public function index($product_id = 0){
            ...
            // debug($product_info['checkout_tax']);
            ...
            $brands = $this->model_catalog_product->getProductManufacturer($product_id);
            ...
            $categories = $this->model_catalog_product->getProductMainCategories2($product_id);
            $data['categ'] = "";
            ...
            $info = array(
				...
				'tax'               => $tax,
				'special'           => $special,
                'tax_label'           => $product_info['tax_label'],
				'rating'            => $rating,
                'href'              => $product_url,
