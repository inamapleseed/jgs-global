			...
			<div class="lower-contact">
				<div class="contact-information">
					...
					<div class="inner-contact-info">
						...
						<div class="tel"><label>(T):&nbsp;</label><a href="tel:<?= $store_telephone; ?>" alt="<?= $store_telephone; ?>" title="<?= $store_telephone; ?>" ><?= $store_telephone; ?></a><br /></div>
				...
				<form id="contact-us-form" action="<?= $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
					...
					<div class="contact-body">
						...
						<div class="form-group required">
							<textarea name="enquiry" rows="7" id="input-enquiry" class="form-control" placeholder="<?= $entry_enquiry; ?>"><?= $enquiry; ?></textarea>
