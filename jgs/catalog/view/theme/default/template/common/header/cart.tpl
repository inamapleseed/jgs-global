<div id="cart" class="relative slide-out-cart" > <!-- add/remove class slide-out-cart for normal opencart cart dropdown-->
    ...
    <ul class="dropdown-menu pull-right"  >
      ...
      <li class="cart-dorpdown-footer" >
          <a href="<?php echo $cart; ?>" class="btn btn-primary text-center"><?php echo $text_cart; ?></a>
          <a href="<?php echo $checkout; ?>" class="btn btn-primary text-center"><?php echo $text_checkout; ?></a>
      </li>
      <?php } else { ?>
