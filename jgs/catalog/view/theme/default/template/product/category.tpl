    ...
    <div id="content" class="<?php echo $class; ?>">
      ...
      <div id="product-filter-replace">
        <div id="product-filter-loading-overlay"></div>
            ...
            <div class="custom-con-x">
              <div class="custom-sort-con"></div>
            </div>
            ...
            <?php if ($products) { ?>    
              <div id="product-filter-detect">
                ...
                <div class="product-count" style="margin-bottom: 15px">
                  <b>Showing All <?php echo $product_count; ?> Products Results</b>
                </div>
