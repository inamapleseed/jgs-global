...
<?php if(!$not_avail) { ?>
    ...
    <div class="form-group<?= ($option['required'] ? ' required' : ''); ?> options">
      ...
      <select name="option[<?= $option['product_option_id']; ?>]" id="input-option<?= $option['product_option_id']; ?>" class="form-control custom-select">
    ...
    <div class="form-group<?= ($option['required'] ? ' required' : ''); ?> radio-set">
      <label class="control-label"><?= $option['name']; ?></label>
      <div id="input-option<?= $option['product_option_id']; ?>" class="inner-div">
        <?php foreach ($option['product_option_value'] as $option_value) { ?>
        <div class="radio">
          <label>
...
<?php } ?>
    ...
    <div class="form-group">
      ...
      <div class="custom-con">
        <?php if(!$enquiry){ ?>
          <?php if(!$not_avail) { ?>
          <button type="button" id="button-cart" data-loading-text="<?= $text_loading; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart"></i><?= $button_cart; ?></button>
          <?php } ?>
        <?php }else{ ?>
