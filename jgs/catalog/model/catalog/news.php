...
class ModelCatalogNews extends Model {
	...
	public function getArchive() {
 	...
 	public function getNewsCategories($data = array()) {
		...
		$sql .= " WHERE ncd.language_id = '" . (int)$this->config->get('config_language_id') . "' AND n.status = '1' AND n2s.store_id = '" . (int)$this->config->get('config_store_id') . "' AND n.date_added < NOW()";
